...
alert("Le pediremos que ingrese unos datos para poder abrir una cuenta");
...
let precioTotal = 0;
  ...
  function eleccionDeProducto(){
    ...
    function ingreso (si){
        alert("Para pagar ofrecemos 6 o 12 cuotas sin interes o 18 cuotas con 10% de interes");
